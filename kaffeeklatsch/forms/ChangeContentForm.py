...
class ChangeContentForm(FlaskForm):
    ...
    newContent = StringField('change your content:', validators =[Length(min=0, max=150, message='Your content cannot be longer than 150 characters!')], render_kw={"placeholder": "new user content"})
