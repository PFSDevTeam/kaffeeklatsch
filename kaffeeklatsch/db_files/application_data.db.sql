...
INSERT INTO "community" ("community_id","community_name","community_tagline","community_content","community_image","community_datejoined") VALUES (1,'test','default tagline','this is the test content','bee_avatar.png','test');
INSERT INTO "community" ("community_id","community_name","community_tagline","community_content","community_image","community_datejoined") VALUES (2,'Coffee Lovers International','coffee is life!','the world runs on hot, caffienated bean juice, and so do we','beaver_avatar.png','test');
...
INSERT INTO "community" ("community_id","community_name","community_tagline","community_content","community_image") VALUES (1,'Books are Best','reading is love,  reading is life','If you like to read, this is the group for you! Post about your favorite books and we can share our literary journey together','bee_avatar.png');
INSERT INTO "community" ("community_id","community_name","community_tagline","community_content","community_image") VALUES (2,'Coffee Lovers International','coffee is life!','The world runs on hot, caffienated bean juice, and so do we','koala_avatar.png');
INSERT INTO "community" ("community_id","community_name","community_tagline","community_content","community_image") VALUES (3,'Movie Fanatics','cinema fans unite','Let''s talk about the latest films, cinematic art at it''s finest is loved by us!','lion_avatar.png');
INSERT INTO "community" ("community_id","community_name","community_tagline","community_content","community_image") VALUES (4,'SportsBall','this group loves sportsball','Round, flat, or in between, join us in cheering or booing teams, sportsball or nothing!','frog_avatar.png');
INSERT INTO "community" ("community_id","community_name","community_tagline","community_content","community_image") VALUES (5,'Code Center','help.exe','Share your code, get your burning questions answered!','macaw_avatar.png');
