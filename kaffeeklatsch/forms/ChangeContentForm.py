...
class ChangeContentForm(FlaskForm):
    ...
    newContent = TextAreaField('change your content:', validators =[Length(min=0, max=500, message='Your content cannot be longer than 500 characters!')], render_kw={"placeholder": "new user content"})
